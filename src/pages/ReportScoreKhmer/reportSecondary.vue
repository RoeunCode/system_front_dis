    ...
    await api
      ...
      .then((res) => {
        classrooms.value = res.data.filter(
          (c) => c.deleted != 1 && c.education_id == 2
        );
                      ...
                      >
                        <tr class="customFont" style="font-size: 11px">
                          ...
                          <th
                            style="height: 0%; width: 2%"
                            class="text-center subjectRankHeader pa-0 font-weight-bold vertical-header"
                            v-if="form.type != 'month' && form.level != 9"
                          >
                            ចំ.ថ្នាក់
                          </th>
                        ...
                        <tbody class="customFont text-center">
                          <tr v-for="(item, idx) in reportData" :key="idx">
                            ...
                            <td
                              ...
                              class="text-center subjectRank bg-deep-orange-lighten-4"
                              :class="
                                item.rankHouseEducation == 1 ||
                                item.rankHouseEducation == 2 ||
                                item.rankHouseEducation == 3
                                  ? 'text-red font-weight-bold'
                                  : 'text-black'
                              "
                            >
                            ...
                            <td
                              style="height: 0; padding: 0"
                              class="text-center subjectRank bg-deep-orange-lighten-4"
                              v-if="form.level != 9 && form.type != 'month'"
                              :class="
                                item.rankPe == 1 ||
                                item.rankPe == 2 ||
                                item.rankPe == 3
